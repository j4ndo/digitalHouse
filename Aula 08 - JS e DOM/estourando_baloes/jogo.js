...
function game_over() {
  alert('Fim de Jogo, você não conseguiu estourar todos os baloes à tempo :\'(');
}
...
function estourar(e) {
  ...
  document.getElementById(id_balao).setAttribute("src", 'imagens/balao_azul_pequeno_estourado.png');
...
function situacao_jogo(qtdBaloes) {
  if (qtdBaloes == 0) {
...
// var links = document.getElementsByTagName('a=img');
